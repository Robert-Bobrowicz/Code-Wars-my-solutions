...
// to show Charlie their entire collection. However, Charlie doesn't like these sessions, since the motive usually repeats.
...
function deleteNth(arr, x) {
    let repeats = {};
    return arr.filter(pic => (repeats[pic] = repeats[pic] + 1 || 0) < x);
}

console.log(deleteNth([1, 1, 1, 1], 2));
console.log(deleteNth([20, 37, 20, 21], 1));
console.log(deleteNth([1,2,3,1,2,1,2,3], 2));
console.log(deleteNth([1,2,3,1,2,4,2,1], 3));